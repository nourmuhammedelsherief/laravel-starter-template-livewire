<div class="flex h-full w-full flex-1 flex-col gap-6 bg-white p-4 dark:bg-[#0a0a0a] lg:p-8">
    <flux:breadcrumbs>
        <flux:breadcrumbs.item href="{{ route('employees.index') }}" wire:navigate class="text-base font-bold">{{ __('employees') }}</flux:breadcrumbs.item>
        ...
        <flux:card class="border-zinc-200 bg-white shadow-2xl dark:border-zinc-700 dark:bg-[#0a0a0a]">
            <div class="space-y-6">
                ...
                <form wire:submit="save" class="space-y-6">
                    <flux:field>
                        <flux:label class="text-base font-extrabold text-neutral-900 dark:text-white">{{ __('Name') }}</flux:label>
                        <flux:input wire:model="form.name" placeholder="{{ __('Enter Name here...') }}" class="border-zinc-200 bg-neutral-50 text-base font-bold text-neutral-900 placeholder:text-neutral-500 focus:border-indigo-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:placeholder:text-zinc-500" />
                        <flux:error name="form.name" />
                    </flux:field>
                    <flux:field>
                        <flux:label class="text-base font-extrabold text-neutral-900 dark:text-white">{{ __('Email') }}</flux:label>
                        <flux:input wire:model="form.email" placeholder="{{ __('Enter email here...') }}" class="border-zinc-200 bg-neutral-50 text-base font-bold text-neutral-900 placeholder:text-neutral-500 focus:border-indigo-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:placeholder:text-zinc-500" />
                    ...
                    <div class="flex items-center justify-start gap-3 border-t border-zinc-200 pt-4 dark:border-zinc-700">
                        ...
                        <flux:button href="{{ route('employees.index') }}" wire:navigate variant="ghost" class="text-base font-bold text-neutral-900 hover:text-black dark:text-white dark:hover:text-zinc-300">{{ __('Cancel') }}</flux:button>
                    </div>
                </form>
            </div>
        </flux:card>
